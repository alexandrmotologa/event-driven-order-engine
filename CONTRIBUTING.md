# Contributing to Event-Driven Order Engine

Thank you for your interest in contributing to Event-Driven Order Engine! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/event-driven-order-engine.git
...
Event-Driven Order Engine is built on **Java 21 LTS** using Apache Maven.

1. **Clone the repository:**
   ```bash
   git clone https://github.com/alexandrmotologa/event-driven-order-engine.git
   cd event-driven-order-engine
   ```
